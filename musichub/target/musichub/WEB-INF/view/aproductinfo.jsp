	...
	<div class="table-responsive">
        ...
        <tbody>  
         	<tr ng-repeat="c in categ | filter:na">
         		...
         		<td><a type="button" href="proedit?code={{c.code}}&type={{c.type}}&name={{c.name}}&price={{c.price}}&manufact={{c.manufact}}&desc={{c.desc}}" class="btn btn-info">UPDATE</a></td>
         		<td><a type="button" href="prodelete?code={{c.code}}" class="btn btn-danger">DLETE</a></td>
         	</tr>
		</tbody>
		</table>
