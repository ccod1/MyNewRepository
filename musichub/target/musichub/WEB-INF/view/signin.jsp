		...
		<center> <form name="loginForm" class="form-horizontal" action="<c:url value='j_spring_security_check' />" method="post">
               ...
               <div class="form-group">
				<label for="username" class="col-sm-2 control-label" > Name:</label>
					<div class="col-sm-5">
						<input type="text" id="username" name="j_username" placeholder="Name......" cssClass="form-control"/>
					</div>
               </div>
               <div class="form-group">
				<label for="username" class="col-sm-2 control-label" > Name:</label>
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" id="password" name="j_password" placeholder="Password......" cssClass="form-control"/>
					</div>
               </div>
